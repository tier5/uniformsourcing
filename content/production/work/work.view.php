...
$query1=("SELECT w.\"ID\" as \"wID\", ".
		 ...
		 "WHERE w.\"clientID\" = c.\"ID\" AND w.\"employeeID\" = e.\"employeeID\" AND w.\"employeeID\" = '".$_SESSION['employeeID']."' AND w.\"open\" = 'no' ".
...
for($i=0; $i < count($data1); $i++){
	if(date("m/d/Y", strtotime($data1[$i]['completiondate'])) < date("m/d/Y")){
		$wID=$data1[$i]['client'];
