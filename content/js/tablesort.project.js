        ...
        prepareTableData: function(table) {
                ...
                for(row = 0; row < numberOfRows; row++) {
                        ...
                        for(var tmp = 0, th; th = sortableColumnNumbers[tmp]; tmp++) {
                                ...
                                if(th.className.search(/sortable-date/) != -1) {
                                ...
                                } else if(th.className.search(/sortable-numericB|sortable-currency/) != -1) {
                                        txt = parseFloat(txt.replace(/[^0-9\.\-]/g,''));
                                        if(isNaN(txt)) txt = "";
                                } else if(th.className.search(/sortableB/) != -1) {
                                        txt = txt.toLowerCase();
                                        ...
                                        if(fdTableSort.dateFormat(txt) != 0) {
                                                ...
                                                fdTableSort.addClass(th, "sortable-numericB");
                                                txt = parseFloat(txt.replace(/[^0-9\.\-]/g,''));
                                                if(isNaN(txt)) txt = "";
                                        } else {
                                                fdTableSort.addClass(th, "sortableB");
                                                txt = txt.toLowerCase();
                                        };
                                };
        ...
        initSort: function(noCallback, ident) {
                ...
                if(dataObj.thList.length > 1) {
                        ...
                        for(var i=0; i < l; i++) {
                                ...
                                if(th.className.match(/sortable-(numericB|currency|date|keep)/)) {
                                        f = "fdTableSort.sortNumeric";
                                } else if(th.className.match('sortableB')) {
                        ...
                        if(!identical) {
                                ...
                                } else if(thNode.className.match('sortableB')) {
