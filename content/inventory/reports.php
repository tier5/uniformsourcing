    ...
    <table width="100%">
        <tr>
          <td align="center"><font size="5">Inventory Reports </font><font size="5"> <br>
            ...
            <?php   if(isset($_SESSION['perm_admin'])&&$_SESSION['perm_admin']=='on')
{?>
...
<?php 
		...
		?>
		<td class="grid001"><a href="reportViewEdit.php?styleId=<?php echo $datalist[$i]['styleId'];?>"><img src="<?php echo $mydirectory;?>/images/reportviewEdit.png" border="0"></a></td>           <?php   if(isset($_SESSION['perm_admin'])&&$_SESSION['perm_admin']=='on')
{
...
{?>   
                <td class="grid001">
		<a <?php if($datalist[$i]['styleId']>0){?>onclick="javascript: if(confirm('Are you sure you want to close the style')) { return true; } else { return false; }" href="reports.php?close=<?php echo $datalist[$i]['styleId'];?>"<?php }else {?>href="#"<?php }?> ><img src="<?php echo $mydirectory;?>/images/close.png" border="0"></a>
                </td> 
<?php }?>
               <?php   if(isset($_SESSION['perm_admin'])&&$_SESSION['perm_admin']=='on')
{?>                
