                ...
                <table width="50%">
                  <tr valign="top">
                   ...
                   <td align="center"><a href="admin/sample_database/database_sample_list.php"><img src="images/sampleDatabase.jpg" alt="Quote" width="165" height="99" border="0" /></a></td>
                    ...
                    <td align="center"><a href="admin/inventory/inventory.php"><img src="images/inventory.jpg" alt="neworkorder" width="165" height="99" border="0" /></a></td>
                    <td align="center"><a href="barcode/barcode_generator.php"><img src="images/barcode.jpg" alt="neworkorder" width="165" height="99" border="0" /></a></td>
                  </tr>
                </table>
                <table width="50%">
                  <tr valign="top">
                    ...
                    <td align="center"><a href="admin/quote/quoteList.php"><img src="images/generateQuote.jpg" alt="Quote" width="165" height="99" border="0" /></a></td>
...
<?php
				...
				else if(isset($_SESSION['employeeType']) && $_SESSION['employeeType'] >0)
				{
?>
				 <table width="50%">
                  <tr valign="top">
