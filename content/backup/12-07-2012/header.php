...
/*echo "<tr><td class=\"menu\" onmouseover=\"this.className='menu_on';\" onmouseout=\"this.className='menu'\" onClick=\"parent.location='$mydirectory/admin/project/project.list.php'\">Projects</td></tr>";*/
