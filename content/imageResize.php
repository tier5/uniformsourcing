...
default:
	...
	ImageCopyResampled($image_c, $new_image, 0, 0, 0, 0, $this->new_width, $this->new_height, $width, $height);
        ...
        if($this->save_folder)
		{
	       ...
	       {
	       $new_name = $this->new_image_name.'.'.$this->new_image_ext;
	       }
	       else
	       {
	       $new_name = $this->new_thumb_name( basename($this->image_to_resize) ).'_resized.'.$this->new_image_ext;
	       }
