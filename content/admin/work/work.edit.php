...
$commonth1=date("F", strtotime($whoop[0]['completiondate']));
$commonth2=date("m", strtotime($whoop[0]['completiondate']));
$comday1=date("d", strtotime($whoop[0]['completiondate']));
$comday2=date("d", strtotime($whoop[0]['completiondate']));
$comyear1=date("Y", strtotime($whoop[0]['completiondate']));
$comyear2=date("Y", strtotime($whoop[0]['completiondate']));
...
for($i=1; $i <= 12; $i++){
	$month1=date("F", mktime(1, 1, 1, $i, 1, date("Y")));
	$month2=date("m", mktime(1, 1, 1, $i, 1, date("Y")));
