...
function calculateSub(tableid)
{
		...
		document.getElementById('amountsubtotal_id').value = subAmountTotal, 2;
		document.getElementById('taxsubtotal_id').value = subTaxTotal, 2;
		document.getElementById('total_id').value = total, 2;
}
