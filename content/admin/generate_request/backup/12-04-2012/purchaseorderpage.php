...
{
	$qid = $_GET['qid'];
	$sql = "Select q.*,cl.client,v.\"vendorName\",pay.payment,emp.firstname,emp.lastname,sh.shipvia,car.carrier from tbl_quote as q left join \"clientDB\" as cl on cl.\"ID\" = q.client_id left join vendor as v on v.\"vendorID\"=q.vendor_id left join tbl_quote_payment as pay on pay.payment_id = q.payment_id left join \"employeeDB\" as emp on emp.\"employeeID\" = q.sales_rep left join tbl_ship_via as sh on sh.ship_via_id = q.ship_via left join tbl_quote_carrier as car on car.carrier_id=q.carrier_id where q.status = 1 and q.qid =$qid";
...
</link></head><body marginwidth=0 marginheight=0 leftmargin=0 topmargin=0>
<?php
...
font-size:12px;color:#000000;line-height:25px;"><strong>Ship Via: </strong></td>'.
                    '<td align="left" valign="top"  style="background-color:#EAEAEA;height:25px;text-align:left;font-family:Tahoma, Verdana, Arial, Helvetica;font-size:12px;
...
font-size:12px;color:#000000;line-height:25px;padding: 0.5em 1em;">$'.$data_quote['total'].'</td>'.
      ...
      '<table style="width: 100%;">'.
          '<tr>'.
            '<td align="left" valign="top" style="background-color:#CCCCCC;height:25px;text-align:left;font-family:Tahoma, Verdana, Arial, Helvetica;
font-size:12px;color:#000000;line-height:25px;padding: 0.5em 1em;"><strong>Intructions/Notes:</strong></td>'.
          '</tr>'.
          '<tr>'.
            '<td align="left" valign="top"  style="background-color:#EAEAEA;height:25px;text-align:left;font-family:Tahoma, Verdana, Arial, Helvetica;font-size:12px;
...
<?php 
 ...
 ?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                  <tr>
                    <td width="150" align="left" valign="top" class="grid001"><strong>Ship Via: </strong></td>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td align="left" valign="top" class="grid001"><strong>Intructions/Notes:</strong></td>
          </tr>
          <tr>
