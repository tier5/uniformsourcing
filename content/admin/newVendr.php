...
if(!count($datacheck)>0)
{
		$querya=("INSERT INTO \"vendor\" "."(  \"address\", \"phone\", \"pager\", \"alphapager\", \"cell\", \"email\",\"city\", \"state\", \"zip\",                  \"active\",\"vendorName\",\"www\",\"country\",\"notes\",\"accountNumber\",\"sales_rep\",\"username\",\"password\") "."VALUES ". "(  '$address', '$phone',                   '$pager','$alphapager', '$cell','$email','$city','$state',                                                                             '$zip','yes','$vendorName','$www','$country','$notes','$account','$sales_rep','$username' ,'$password')"); 
