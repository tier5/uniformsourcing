        ...
        for($i=0; $i<count($data_prjNotes); $i++)
        {
			...
			$html .= ' <td ><textarea id="title_Id'.($i+1).'"  style="display:none">'.stripslashes($data_prjNotes[$i]['title']).'</textarea>
					<textarea id="txtAreaId'.($i+1).'"  style="display:none">'.stripslashes($data_prjNotes[$i]['notes']).'</textarea>
                               <input type="hidden" id="prj_note_type'.($i+1).'" value="'.$data_prjNotes[$i]['prj_note_type'].'" />             
...
<table width="80%" border="0" cellspacing="1" cellpadding="0">
 <tr>
  ...
  <td align="left">Notes:</td>
    ...
    <td>&nbsp;</td> 
    <td align="left">Internal<input type="radio" id="prj_note_type" name="prj_note_type" value="int" class="prj_note_type"/>&nbsp;External<input type="radio" id="prj_note_type" name="prj_note_type" value="ext" class="prj_note_type"/></td>
  </tr> 
    <tr>
...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left"><strong>Type :</strong></td>
    <td>&nbsp;</td>
    <td align="left"><p id="editprjnote"></p></td>
  </tr> 
</table>';
//echo $html;
