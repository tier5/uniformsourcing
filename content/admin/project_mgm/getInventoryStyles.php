...
switch ($_GET['opt']) {
 ...
 if (isset($inv_quantity) && $inv_quantity != "" ) {
                    //  $query_Name.=' "height"='.$height;
                    if ($q_add == "")
                        $q_add.=' "pulltime_inv_qty"=0';
                    else
                        $q_add.=' ,"pulltime_inv_qty"=0';
                }
     ...
     //echo "inv->".$qty;  
         ...
         if (isset($style_id) && $style_id != "") {
             ...
             $query_Name .= ' ,	inv_pull_qty='.$data_qty;
              $query_Name .= ' ,pulltime_inv_qty='.$inv_quantity;
