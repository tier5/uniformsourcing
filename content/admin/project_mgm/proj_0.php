...
{
	$sql = "Select projectname,color,client,materialtype,project_manager,project_manager1,project_manager2,stock_or_custom from tbl_newproject".$tx." where  pid = $pid";
	//echo $sql;
...
if($emp_type >1)
{
	...
	$html .=' value="'.htmlentities(str_replace("''", "'",$data_prj['projectname'])).'" /></td>'.
'</tr>'.
'<tr>'.
