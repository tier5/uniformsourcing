...
$sql='select Distinct(prj.projectname), prj.is_billed, prj.bill_date, prch.createddate,c.client,prj.pid,prj.order_placeon,prj.status,emp.firstname,emp.lastname ,prch.purchaseorder,prch.pt_invoice,tbl_carriers.weblink,
