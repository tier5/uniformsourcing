...
$sql = 'select Distinct(prj.projectname), prj.bid_number,prj.project_budget,c.client,prj.pid,prj.order_placeon,prj.status,'
        ...
        <table width="100%" cellspacing="0" cellpadding="0" style="border:1px white solid;" class="no-arrow rowstyle-alt">
            ...
            <thead style="border:1px white solid;">
                <tr class="sortable"> 
                    ...
                    <th class="sortable-numericB">Project Budget</th>
<?php
if ($is_session != 1) {
    ?>
                        <th class="sortable-numericB">Project Estimatd Unit Cost</th>
                        <th class="sortable-numericB">Production target Delivery</th>
...
?>
                    ...
                    if (count($datalist)) {
                        for ($i = 0; $i < count($datalist); $i++) {
                            ...
                            echo '<td class="grid001B">' . $datalist[$i]['project_budget'] . '</td>';
                            if ($is_session != 1) {
