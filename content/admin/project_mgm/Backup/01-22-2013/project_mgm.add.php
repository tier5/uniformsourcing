...
echo $data_Vendr[$i]['vendorName'];?></option><?php
	  ...
	  +'<tr><td align="right">Order Date:</td><td align="left"><input type="text" name="order_date[]" id="order_date" onclick="javascript:showDate(this);" value="" /></td></tr>'
...
+'&nbsp;&nbsp; <img src="<?php echo $mydirectory;?>/images/bullet_add.png" alt="Add" onclick="javascript:AddTrackingNum('+rowCount+');"/></td>'
 ...
 ?>/images/courier_man.jpg" width="50"/></a></div></td></tr>'
...
+'<tr><td width="50%" height="25" align="right">Shipping Notes:</td><td align="left" valign="top" height="25px">&nbsp;</td>'
...
function AddTrackingNum(rowCount)
{
 ...
 echo $data_order_shipping[$i]['weblink'].$data_order_shipping[$i]['tracking_number'];?>\');"><img src="<?php echo $mydirectory;
 ?>/images/courier_man.jpg" width="50"/></a></div></td>'+
  '</tr>';  
