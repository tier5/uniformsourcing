...
$bid ='Choose Quote Number: <select name="bid" id="bid" onchange="javascript:get_project();" >'.
...
$bid .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>Project Name: <input type="text" name="project_text" id="project_text" readonly="readonly" value="'.$bid_num['project_name'].'" />
