...
.'emp.firstname,emp.lastname,prch.purchaseorder,prc.prjquote,prc.prjcost,prc.prj_completioncost,prc.targetpriceunit,prc.targetretail,'
        ...
        <table width="100%" cellspacing="0" cellpadding="0" style="border:1px white solid;" class="no-arrow rowstyle-alt">
            ...
            <thead style="border:1px white solid;">
                <tr class="sortable"> 
                    ...
                    <th class="sortable-numericB">Target Price Per Unit</th>
                    <th class="sortable-numericB">Target Retail Price</th>
...
?>
                    ...
                    if (count($datalist)) {
                        for ($i = 0; $i < count($datalist); $i++) {
                            ...
                            echo '<td class="grid001B">$' . $datalist[$i]['targetpriceunit'] . '</td>';
                            echo '<td class="grid001B">$' . $datalist[$i]['targetretail'] . '</td>';
