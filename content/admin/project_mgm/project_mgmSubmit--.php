...
//-------------------------------------------------------------		
    ...
    $query_Name = ';delete "tbl_qty_shipped" where " = '.$shipping_id.';';                
                $query_Name.="INSERT INTO tbl_qty_shipped (";
                $query_Name.=" trk_id";
                //$query_Name.= ", style_id";
		$query_Name.= ", qty_ship";
                
                $query_Name.=" ) VALUES(";
                $query_Name.=" $shipping_id ";
               // $query_Name.=", $prj_style_id ";
		$query_Name.=",".$_POST['shipping_'.$i];                
                $query_Name.=" );";      
...
$query_Name = 'UPDATE "tbl_qty_shipped" SET "qty_ship"=\''.$_POST['shipping_'.$k].'['.$i.']\' where "trk_id" = '.$shipping_id.';';   
