...
if(isset($_POST['pid']) && $_POST['pid']!=0){
	 $sql = 'select "sent_date","confirm_num","vendor_po","upload_file","tbl_vendorid",pid,vid,vendor."vendorName" from tbl_prjvendor'.$tx.' inner join vendor '
.' on vendor."vendorID"=tbl_prjvendor'.$tx.'.vid where status =1 and pid ='. $pid;
	//echo $sql;
