...
{
	$id = $_GET['del'];
	$sql = "DELETE from tbl_sample_uploads where sampleid = $id;";
	$sql .= "DELETE from \"tbl_sampleRequest\" where id = $id;";
                ...
                <tr>
                  <td align="center" valign="top">
                    ...
                    <table width="100%" cellspacing="1" cellpadding="0" class="no-arrow rowstyle-alt">
					  ...
					  ?>
                      <tr>
                        <td height="25" align="right" valign="top" class="grey"><a href="samplerequest_new.add.php?id=<?php echo $datalist[$i]['id'];?>&page=arc"><?php echo $datalist[$i]['srID'];?></a></td>
