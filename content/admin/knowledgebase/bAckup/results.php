...
if($selectdate == "week"){
	$dateselect=((mktime(date("H"), date("i"), date("s"), date("m"), date("d"), date("Y"))) - 604800);
	$selectdate1="AND \"creationdate\" >= '$dateselect'";
}
if($selectdate == "month"){
	$dateselect=((mktime(date("H"), date("i"), date("s"), date("m")-1, date("d"), date("Y"))) - 2678400);
	$selectdate1="AND \"creationdate\" >= '$dateselect'";
}
$query1=("SELECT * ".
		 "FROM \"knowledgebase\" ".
...
echo "<td><font face=\"arial\" size=\"-1\"><b>Edit/Delete</font></td>";
echo "</tr>";
for($i=0; $i < count($data1); $i++){
	...
	echo "<td>";
	echo "<font size=\"-1\" face=\"arial\"><a href=\"detail.php?articleID=".$data1[$i]['articleID']."\">Edit</a>";
	echo "<br><a href=\"delete.php?articleID=".$data1[$i]['articleID']."\">Delete</a></font></td>";
	echo "</tr>";
}
echo "</table>";
echo "</center>";
