...
{
	$id = $_GET['del'];
	$sql = "Update \"tbl_sampleRequest\" SET status = 0 , \"modifiedDate\" = ".date('U')." where id = $id";
                      ...
                      <table width="95%" border="0">
					   ...
					   <?php
                        ...
                        <tr>
                          ...
                          <td align="center">&nbsp;</td>
                          <td align="center">&nbsp;</td>
                          <td align="right" valign="top"><input type="submit" name="archieve_btn" id="archieve_btn" value="View Archived Requests" onclick="javascript:location.href='samplerequest.archive.list.php'" />                            <input name="btnAdd" type="button" onclick="javascript:location.href='samplerequest_new.add.php'"  onmouseover="this.style.cursor = 'pointer';" value="Add Sample Request" /></td>
                        </tr>
                    </table>
