...
function Print()
    ...
    function Popup(data) 
    {
        ...
        mywindow.document.write('<html><head><title>Label</title>');
...
<div id="qrcode" style=" width:200px; height:200px; background-color:red; float:right; "></div>
<div id="style" style=" width:90%; height: auto; font-size:248px; padding:5%; margin:auto; text-align:center; clear: both;">
	</div>
</div>
</div>
