...
echo "<br><br>";
echo "<center>";
echo "<a href=\"image_file/image_file_list.php\"> Picture/File Package </a> |";

echo "<a href=\"element/element_list.php\"> Element Package</a> ";
echo "</center><br/>";
echo "<center>";
...
echo "<br>";
echo "<a href=\"sample_database/conveyor_edit01.php\">Add / Edit a Conveyor</a>";
echo "<br>";
