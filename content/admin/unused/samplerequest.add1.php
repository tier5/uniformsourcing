...
$order_confirmation = pg_escape_string($order_confirmation);
$bid_number = pg_escape_string($bid_number);
$project_budget = pg_escape_string($project_budget);
$shipped_on = pg_escape_string($shipped_on);
$shipping_notes = pg_escape_string($shipping_notes);
...
if(isset($_POST['id']))
{
	...
	if($id == 0)
	{
		...
		if($order_confirmation!="") $query4.=", order_confirmation ";
		if($order_on!="") $query4.=", order_on ";
		if($bid_number!="") $query4.=", bid_number ";
		if($project_budget!="") $query4.=", project_budget ";
		if($carrier_shipping!=0) $query4.=", carrier_shipping ";
		if($shipped_on!="") $query4.=", shipped_on ";
		if($shipping_notes!="") $query4.=", shipping_notes ";
		...
		if($sampletype!="") $query4.=", '$sampletype' ";
		if($sample_name!="") $query4.=", '$sample_name' ";
		if($ordered_date!="") $query4.=", ".strtotime($ordered_date);
		if($tracking_number!="") $query4.=", '$tracking_number' ";
		if($order_confirmation!="") $query4.=", '$order_confirmation' ";
		if($order_on!="") $query4.=", '$order_on' ";
		if($bid_number!="") $query4.=", '$bid_number' ";
	...
	else if($id > 0)
	{
		...
		if(isset($order_confirmation) && $order_confirmation!="")$query4.="order_confirmation = '$order_confirmation', ";
		else if(isset($order_confirmation)) $query4.="order_confirmation = null, ";
		if(isset($order_on) && $order_on!="")$query4.="order_on = '$order_on', ";
		else if(isset($order_on)) $query4.="order_on = null, ";
		if($bid_number!="")$query4.="bid_number = '$bid_number', ";
		else $query4.="bid_number = null, ";
		if($project_budget!="")$query4.="project_budget = '$project_budget', ";
		else $query4.="project_budget = null, ";
		if($carrier_shipping!=0)$query4.="carrier_shipping = '$carrier_shipping', ";
		else $query4.="carrier_shipping = null, ";
		if($shipped_on!="")$query4.="shipped_on = '$shipped_on', ";
		else $query4.="shipped_on = null, ";
		if($shipping_notes!="")$query4.="shipping_notes = '$shipping_notes', ";
		else $query4.="shipping_notes = null, ";		
