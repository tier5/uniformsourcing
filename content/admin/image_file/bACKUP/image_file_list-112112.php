...
{
     $client_join = " left join img_file_clients as clients on clients.cid = (select c.cid from img_file_clients as c where c.pack_id = main.pack_id limit 1)";
 if($where=="")
 {    
...
{
    $style_join = " left join img_file_styles as styles on styles.style = (select s.style from img_file_styles as s where s.pack_id = main.pack_id limit 1)";
 if($where=="")
