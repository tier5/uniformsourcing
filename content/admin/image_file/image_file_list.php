...
$sql = 'SELECT distinct main.*,(select client.client from img_file_clients as pack left join "clientDB" as client '.
 ' on client."ID"=pack.cid where pack.pack_id=main.pack_id limit 1) as client_name FROM "img_file_pack" as main'.$style_join. $client_join. $where." order by main.createddate desc";
//echo $sql;
