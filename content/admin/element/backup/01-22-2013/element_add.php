...
echo $pid;?>')" src="../../images/delete.png">
	...
	<td align="left"><select name="elementtype[]" <?php echo $style_price;?> id="elementtype" onChange="showlocation();">
...
<option value="<?php echo $element_list[$i];?>"><?php echo $element_list[$i];?></option>
    ...
    <?php if(0){ ?>
    <tr id="location_tr" <?php echo 'style="visibility:hidden"'; ?> >
...
<option value="<?php echo $data_vendor[$i]['vendorID'];?>" selected="selected">
    ...
    <td><input type="text" name="elementlabor[]" id="elementlabor" value="<?php echo $datalist[$j]['labor']; ?>"  /></td>
    </tr>
    <tr>
    <td align="right">Order Date</td>
    <td><input type="text" name="order_date[]" id="order_date" onclick="javascript:showDate(this);" value="<?php echo $datalist[$j]['order_date']; ?>"  /></td>
    </tr>
    <tr>
    <td align="right">Confirmation Number</td>
    <td><input type="text" name="element_conf_num[]" id="element_conf_num" value="<?php echo $datalist[$j]['conf_num']; ?>"  /></td>
    </tr>
    <tr>
    <td align="right">Tracking Number</td>
    <td><input type="text" name="element_track_num[]" id="element_track_num" value="<?php echo $datalist[$j]['track_num']; ?>"  /></td>
    </tr>
    <tr>
    <td align="right">Delivered</td>
    <td>
    <?php
    if($datalist[$j]['delivered'] == "on"){
	echo "<input type=\"checkbox\" name=\"element_delivered[]\" checked>";
}else{
	echo "<input type=\"checkbox\" name=\"element_delivered[]\">";
}?>
</td>
    </tr>
    <tr>
...
<script type="text/javascript" src="<?php echo $mydirectory; ?>/js/project.js" ></script>
...
echo '</select></td></tr>';
    ";*/
      ...
      +'</td></tr>'
	  +'<tr><td align="right">Labor:</td>'
	  +'<td><input type="text" name="elementlabor[]" id="elementlabor" /></td></tr>'
	   +'<tr><td align="right">Order Date:</td>'
	  +'<td><input type="text" name="order_date[]" id="order_date" onclick="javascript:showDate(this);" value="" /></td></tr>'
	  +'<tr><td align="right">Confirmation Number:</td>'
	  +'<td><input type="text" name="element_conf_num[]" id="element_conf_num" /></td></tr>'
	  +'<tr><td align="right">Tracking Number:</td>'
	  +'<td><input type="text" name="element_track_num[]" id="element_track_num" /></td></tr>'
	  +'<tr><td align="right">Delivered:</td>'
	  +'<td><input type="checkbox" name="element_delivered" id="element_delivered" checked="checked"  /></td></tr>'
...
if($('#elementtype').val()=='Beads')
{
$('#location_tr').css({visibility: "visible"});$('#location').val('');$('#location').focus();
}
else
{$('#location_tr').css({visibility: "hidden"});$('#location').val($('#elementtype').val());
}	   	
}
