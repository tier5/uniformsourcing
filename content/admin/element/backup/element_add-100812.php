        ...
        <tr>
            <td valign="top">
                ...
                <table align="center">
                    ...
                    <td align="left"><input type="text" name="packagename" id="packagename" value="<?php echo stripslashes($datalist['package']); ?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><select name="vendor">
                    ...
                    for ($i = 0; $i < count($data_vendor); $i++) {
                        ...
                        if ( isset($datalist['vendor_id']) && $datalist['vendor_id'] == $data_vendor[$i]['vendorID'])
                            echo ' selected="selected" ';
...
<?php if (!isset($datalist['file']) || $datalist['file'] == "") echo " style='display:none;'"; ?>
            ...
            <td>File:<br/>
               ...
               <?php if(isset($datalist['file']) && $datalist['file']!="")
                {?>
                <a href="download.php?file=<?php echo $datalist['file']; ?>">
                    <img src="<?php echo $mydirectory; ?>/images/Download.png" alt="download"/></a><?php } ?>
