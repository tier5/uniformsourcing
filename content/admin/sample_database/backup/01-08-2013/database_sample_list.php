...
$mainQuery='select s.brand_manufct,s.style_number,s.detail_description,s.sample_id,s.sample_id_val,s.vid,s.size,s.color,s.samplecost,s.retailprice,vendor."vendorName" from tbl_sample_database as s left join vendor on vendor."vendorID" = s.vid where s.status=1 '.$search_sql.' order by s.modifieddate  desc';
$sql = $mainQuery;
...
<tr>
<td width="100" class="grid001">Brand/Manufacturer: </td>
 	<td width="400" class="grid001"><label>
 	  <input type="text" name="brand_manufacture" id="brand_manufacture" />
 	  </label></td>
  <td width="20" class="grid001">&nbsp;</td>
  <td width="110" class="grid001">Sample ID: </td>
  <td class="grid001"><input type="text" name="sample_id" id="sample_id" /></td>
 </tr>
 <tr>
   <td class="grid001">Detailed Description</td>
   <td class="grid001"><input type="text" name="detailed_description" id="detailed_description" /></td>
   <td class="grid001">&nbsp;</td>
   <td class="grid001">StyleNumber</td>
   <td class="grid001"><input type="text" name="style_number" id="style_number" /></td>
 </tr>
 <tr>
...
<table width="100%" cellspacing="1" cellpadding="1" style="border:1px white solid;" class="no-arrow rowstyle-alt">
    ...
    <tr class="sortable"> 
            ...
            <th class="sortable" height="10"><span class="grid001">Brand/Manufacturer</span></th>
