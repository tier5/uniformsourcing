...
<table width="85%" cellspacing="1" cellpadding="1" border="0">
                ...
                <td>&nbsp;</td>
                <td valign="top" align="left"><select name="clientname">                   
                ...
                <tr>
                 ...
                 <td height="25" valign="top" align="right">Description:</td>
				  <td width="10">&nbsp;</td>
    				<td align="left"><textarea id="detaildesc" name="detaildesc" cols="30" rows="4"><?php echo htmlentities($data_sample['detail_description']);?></textarea></td>
    			</tr>
                <tr>
...
?>
                ...
                <tr>
				  ...
				  <td valign="top" align="left"><table width="250" cellspacing="0" cellpadding="0" border="0">
				    <tbody><tr>
				      <td valign="top" align="left"><input type="file" name="picture1" id="picture1" onchange="javascript:ajaxFileUpload('picture1','I',document.getElementById('id'));" /></td>
				      </tr>
				      </tbody></table></td>
				  </tr>
                ...
                <option value="">--- Select Locations-----</option>
                   <?php for($i=0; $i <count($data_location); $i++)
				   {
					if($data_sample['location']==$data_location[$i]['locationId'])
