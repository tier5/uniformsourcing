...
if(isset($_POST['pid']) && $_POST['pid']!=0)
{
 ...
 {//echo $i."<br/>";
  if(isset($data_order_shipping[$i]['shipping_id']) && $data_order_shipping[$i]['shipping_id']!="")
  {
      ...
      $track_no[$i]=array();
 $q='select tracking_no,track_id from tbl_prjorder_track_no where shipping_id='.$data_order_shipping[$i]['shipping_id'];
...
$html .='<tr><td width="50%" height="25" align="right">Tracking Number:</td><td align="left" valign="top" height="25px">&nbsp;</td><td width="49%"> <input  value="'.$track_no[$i][$j]['tracking_no'].'" name="track_shipping['.$i.'][]" id="track_num'.$i.'" type="text" value="">&nbsp;&nbsp;'
.'<img src="'.$mydirectory.'/images/x.jpg" border="0" alt="delete" onclick="javascript:$(this).parent().parent().remove();" '
