...
if (isset($_GET['close'])) {
 ...
 $tbl_list=array(array('tbl_newproject','rr'),array('tbl_prjpurchase','purchaseId'),array('tbl_prjimage_file','tbl_prjimage_file'),array('tbl_prj_style','prj_style_id'),
  array('tbl_prjvendor','tbl_vendorid'),array('tbl_prjsample_uploads','upload_id'),
 array('tbl_prjsample_notes','notes_id'),array('tbl_prj_sample_po','id'),array('tbl_prj_sample_po_items','id'),array('tbl_prj_sample','sample_id'),
...
$sql = 'select Distinct(prj.projectname),ship.carrier_id,track_nos.tracking_no, prj.bid_number,prj.project_budget,c.client,prj.pid,prj.order_placeon,prj.status,ship.tracking_number ,'
