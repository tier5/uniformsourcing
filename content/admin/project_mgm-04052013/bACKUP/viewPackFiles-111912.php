...
//print_r($data_prjUploads);
	...
	pg_free_result($result);
        echo '<table id="upld_pack_'.$pack_id.'"><tr><td align="right">'.
		
		'<input type="hidden" name="upload_packages[]" value="'.$pack_id.'"/></td></tr>'.
		'<tr><td>Style Number: <strong>'.$data_prjUploads[0]['pack_name'].'</strong> <img  onclick="$(\'#upld_pack_'.$pack_id.'\').remove()" src="../../images/delete.png" />.</td></tr>';
           if (count($imageArr)) {
 ...
 width="101" height="89" onClick="PopEx(this, null,  null, 0, 0, 50, 'PopBoxImageLarge');"/>
  ...
  <!--   <a style="cursor:hand;cursor:pointer"
     ...
     if (count($fileArr)) {
         echo "<tr><td><br/></td></tr><tr><td>Files:</td></tr>";
       ...
       <a href="download_file_pack.php?file=<?php echo $fileArr[$i]['file']; ?>">
