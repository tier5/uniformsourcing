...
if(isset($pid)&&$pid!="")
{
$sql = "Select * from tbl_prj_elements$tx where status =1 and pid = $pid";
...
for($j = 0; $j < count($data_prj_element_all); $j++)
{
	...
	'<tr>
	<td align="right">Order Date:</td>
	<td align="left"><input type="text" name="order_date[]" id="order_date" onclick="javascript:showDate(this);" value="'.$data_prj_element_all[$j]['order_date'].'" '.$style_price.' /></td>
	</tr>'.
	'<tr>
	<td align="right">Confirmation Number:</td>
	...
	'<tr>
	<td align="right">Delivered:</td>
	<td align="left"><input type="checkbox" name="element_delivered" id="element_delivered" value="'.$data_prj_element_all[$j]['elem_delivered'].'" '.$style_price.' /></td>
	</tr>'.
	'<tr>
