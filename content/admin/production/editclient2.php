...
echo "<center>";
echo "<p>";
echo "<form action=\"editclient3.php\" method=\"post\" enctype=\"multipart/form-data\">";
...
echo "</tr>";
echo "<tr>";
echo "<td><b>Intranet url:</b></td>";
echo "<td><input type=\"text\" name=\"intranet\" value=\"".$data1[0]['intranet']."\"></td>";
echo "</tr>";
echo "<tr>";
...
echo "<tr>";
echo "<td><b>Logo:</b></td>";
echo "<td><input type=\"file\" name=\"logo\" value=\"".$data1[0]['logo']."\">";
if($data1[0]['logo']!='')
{
	echo '<br><img src="'.$target_dir.$data1[0]['logo'].'" width="150px">';
}
echo "</td></tr>";
echo "<tr>";
