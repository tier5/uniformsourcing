...
for($i=0; $i < count($data_color); $i++){
    ...
    <td>&nbsp;<input  type="button" name="del_qnt" id="del_qnt" value="Delete All Quantities" 
                 onclick="javascript:delAllQnts();" class="ui-button ui-widget ui-state-default ui-corner-all"/></td></form>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
function delAllQnts()
{
 if(!confirm("This will delete all the quantities in this particular style and color...!!Do you want to contine?")) return;
