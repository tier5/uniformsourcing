...
?>
                       <tr>
                        ...
                        <td width="150"><?php echo $data_ware[$i]['row'];?></td>
                        <td>&nbsp;</td>
                        <td width="10">&nbsp;</td>
                      </tr>
<?php 
...
?>
                       <tr>
                        ...
                        <td width="150"><?php echo $data_ware[$i]['rack'];?></td>
                        <td>&nbsp;</td>
                        <td width="10">&nbsp;</td>
                      </tr>
<?php 
...
?>
                       <tr>
                        ...
                        <td width="150"><?php echo $data_ware[$i]['shelf'];?></td>
                        <td>&nbsp;</td>
                        <td width="10">&nbsp;</td>
                      </tr>
<?php
...
?>
                       <tr>
                        ...
                        <td width="150"><?php echo $data_ware[$i]['box'];?></td>
                        <td>&nbsp;</td>
                        <td width="10">&nbsp;</td>
                      </tr>
                      <tr>
