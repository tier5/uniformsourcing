								...
								if($data_opt1Size[$j]['opt1SizeId'] > 0)
								{
									if(($data_inv[$m]['sizeScaleId'] == $data_mainSize[$k]['mainSizeId']) && ($locArr[$i] ==$data_inv[$m]['locationId']) && ($data_opt1Size[$j]['opt1SizeId'] == $data_inv[$m]['opt1ScaleId']))
									{
										...
										if($data_inv[$m]['inventoryId'] != "")
										{
											...
											{	
											$print.='<td bgcolor="#cccccc" width="100" height="25" align="center" ><font color="#ffffff" >'. $data_inv[$m]['quantity'].'</font></td>';
											}
											else
											{
												if($data_inv[$m]['newQty'] !="")
												{
												$print.='<td bgcolor="#cccccc" width="100" height="25" align="center" ><font color="#ffffff" >'.$data_inv[$m]['newQty'].'</font></td>';
												}
												else
												{
													$print.='<td bgcolor="#cccccc" width="100" height="25" align="center" ><font color="#ffffff" >0</font></td>';
												}
