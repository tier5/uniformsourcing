...
$path_parts = pathinfo($return_arr['msg']);
//print_r($path_parts);
$return_arr['filename']=str_replace ( '&' , '121212090909567845689' , $path_parts['filename'] );
$return_arr['filename']=str_replace ( '.' , 'QM98712412qr' , $return_arr['filename'] );
$return_arr['msg']=$return_arr['filename'].".".$path_parts['extension'];
$return_arr["error"] = $error;
echo json_encode($return_arr);
return;
?>