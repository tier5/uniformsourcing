...
if(isset($_POST['sbtbutton']))
  {
		...
		if($quanPeople!=0)
			...
			else
			{
				 ...
				 /* $query="UPDATE \"projectEstimatedUnitCost\" SET \"ptrnsetup\"='".$ptrnsetup.                         "',\"grdngsetup\"='".$grdngsetup."', \"smplefeesetup\"='".$smplefeesetup.                         "',\"fabric\"='".$fabric."',\"trimfee\"='".$trimfee."',\"labour\"='".$labour                         ."',\"duty\"='".$duty."',\"frieght\"='".$frieght."',\"other\"='".$other."'                         WHERE \"tbl_projects_id\"=".$_SESSION['pid'];*/
			}
...
<script type="text/javascript">	
	...
	{	
			...
			smplefeesetup=document.prjctEst.smplefeesetup.value;			
				...
				document.prjctEst.other.value=otherfield.toFixed(2);
				}
				else
    ...
    <tr>
      <td align="center"><font face="arial"><font size="5">P</font><font size="5">roject Estimated Unit Cost
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left"><input name="button2" type="button" onMouseOver="this.style.cursor = 'pointer';"  value="Back" onClick="javascript:location.href='project.edit.php?ID=<?php echo $_SESSION['pid'];?>'"/><td/>
          </tr>
        </table>
        <font size="5">&nbsp;
        </font>
          <table width="80%" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td align="left" valign="top"><input id="other" name="other" type="text" class="textBox" value="<?php echo $other;?>" readonly=""/></td>
            </tr>
            <tr>
              ...
              <td>&nbsp;</td>
              <td align="left"><input name="button2" type="submit" onMouseOver="this.style.cursor = 'pointer';"  value="Cancel" /></td>
            </tr>
      </table></td>
    </tr>
  </table>
